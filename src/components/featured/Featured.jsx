  ...
  return (
    <div className='featured container'>
      ...
      <div className="featured__listings">
        ...
        <Listing price='$900,000' title='Modern Home' address='1755 Glendale Avenue, Woodland Hills' image={property2} imageWebp={property2webp} owner='Richard Doe' ownerImage={owner2} ownerImageWebp={owner2webp} />
